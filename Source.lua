...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("Quitkat Hub.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
	local WTitle = Configs[1] or Configs.Name or Configs.Title or "Quitkat Hub"
	local WMiniText = Configs[2] or Configs.SubTitle or "by : beto0123"
